        ...
        <ul className="flex items-center justify-center py-2">
            <li>
                {data.prev_page_url !== null
                    ...
                    :
                    <span
                        className="flex items-center justify-center border border-gray-200 h-10 w-10 text-sm text-gray-300"
                    >
                        <RiArrowLeftSLine size={16} />
                    </span>
                }
            ...
            <li>
                {data.prev_page_url !== null
                    ...
                    :
                    <span
                        className="flex items-center justify-center border-y border-r h-10 w-10 text-sm text-gray-300"
                    >
                        <RiArrowLeftDoubleLine size={16} />
                    </span>
                }
            ...
            <li>
                {data.next_page_url !== null
                    ...
                    :
                    <span
                        className="flex items-center justify-center border-y border-r border-gray-200 h-10 w-10 text-sm text-gray-300 duration-300"
                    >
                        <RiArrowRightDoubleLine size={16} />
                    </span>
                }
