                        ...
                        <CardBody className=" border-y border-gray-100">
                            ...
                            <div className="px-3 my-4">
                                ...
                                <div className="flex flex-col mt-6">
                                    <label className="label-form" htmlFor="recebimento">
                                        Recibo de recebimento de equipamento
                                    </label>
                                    <textarea
                                        id="recebimento"
                                        value={data.recebimento}
                                        onChange={(e) => setData('recebimento', e.target.value)}
                                        className="input-form"
                                    />
                                </div>

                                <div className="flex flex-col mt-6">
                                    <label className="label-form" htmlFor="entrega">
                                        Recibo de entrega do equipamento
                                    </label>
                                    <textarea
                                        id="entrega"
                                        value={data.entrega}
                                        onChange={(e) => setData('entrega', e.target.value)}
                                        className="input-form"
                                    />
                                </div>
