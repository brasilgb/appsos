...
const EditOrdem = ({
    ...
    async function handleSubmit(e: any) {
        ...
        router.post(`/ordens/${ordens.id}${oc ? '?oc='+oc : ''}`, {
            ...
            status: data.status,
            dtentrega: ordens.dtentrega ? ordens.dtentrega : null,
            dtfeedback: ordens.dtentrega ? moment(ordens.dtentrega).add(30, 'days').format("DD/MM/YYYY") : null,
                                                ...
                                                <div className="flex items-start justify-start w-full">
                                                    ...
                                                    <div>
                                                        <button
                                                            title="Inserir peças"
                                                            type="button"
                                                            className="bg-blue-600 hover:bg-blue-600/90 py-2.5 px-3  shadow text-gray-50 h-10 rounded-tr-md"
                                                        ...
                                                        <button
                                                            ...
                                                            className="bg-red-600 hover:bg-red-600/90 py-2.5 px-3 shadow text-gray-50 h-10 rounded-br-md"
                                                        >
                                                            <IoTrash size={22} />
                                                        </button>
                                                    </div>
