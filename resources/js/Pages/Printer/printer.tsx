            ...
            <div className="text-[10px] text-gray-600 relative">
                ...
                {codigobarras && tipo == "1" &&
                    <div className="flex-auto pr-8 flex flex-col items-end justify-end absolute right-0 -bottom-20">
                        <p className="text-center">Acompanhe o status de  sua ordem de serviço em  <br/> https://eplusteutonia.com.br/login <br/>Usuário: CPF/CNPJ - senha: 12345678 <br/> <span className="text-red-500">Após logar altere sua senha.</span></p>
