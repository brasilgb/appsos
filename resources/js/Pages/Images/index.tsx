...
import { IoClose, IoImageSharp, IoSearchCircle, IoTrash } from "react-icons/io5"
            ...
            <Card>
                ...
                <CardContainer>
                    <CardHeader>
                        ...
                        <CardHeaderContent>
                            <h1 className="text-xl text-sky-700 font-bold">Ordem N° #{ordem}</h1>
                        </CardHeaderContent>
                    </CardHeader>
                        ...
                        <CardBody className="border-y border-gray-100">
                            <div className="p-3">
                                <input
                                    ...
                                    type="text"
                                    value={data.ordem_id}
                                    onChange={(e) => setData('ordem_id', e.target.value)}
                                    className="hidden"
                                />
                                <div className="flex items-center justify-center">
                                    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                            ...
                                            <p className="mb-2 text-sm text-gray-500 dark:text-gray-400"><span className="font-semibold">Clique para fazer upload</span></p>
                                            <p className="text-xs text-gray-500 dark:text-gray-400">PNG ou JPG</p>

                                            <h1 className="text-lg mt-2 text-gray-500">Arquivos selecionados {data?.imagem ? data?.imagem?.length : '0'}</h1>

                                        </div>
                                        <input
                                            id="dropzone-file"
                                            type="file"
                                            onChange={(e) => setData('imagem', e.target.files)}
                                            className="hidden"
                                            multiple
                                            draggable
                                        />
                                ...
                                <div className="mt-4">
                                    {errors.imagem && <div className="text-sm text-red-500">{errors.imagem}</div>}
                                </div>
                                    ...
                                    {imagens.map((image: any) => (
                                            ...
                                            <div className="absolute flex items-center justify-between left-0.5 right-1 top-0.2">
                                                ...
                                                <div className="text-red-600">
                                                    <IoTrash size={20} className="cursor-pointer" onClick={(e) => handleDeleteImage(e, image.id)} />
                                                </div>
                                            </div>
                                            <div className="p-2">
                                                <figure className="max-w-lg">
